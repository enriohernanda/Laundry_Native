...
$rowEdit = mysqli_fetch_assoc($selectLevel);
// var_dump($level);
                ...
                <div class="card-body">
                    <form action="" method="post">
                        ...
                        <input type="text" class="form-control w-50 mb-3" name="name"
                            value="<?php echo $rowEdit['name'] ?? '' ?>" placeholder="Enter level name" readonly>
                            ...
                            <?php foreach ($rowMenus as $menu): ?>
                                <label for="" class="form-label">
                                    <input type="checkbox" name="menu_id[]" value="<?php echo $menu['id'] ?>"
                                        <?php echo in_array($menu['id'], $selectedMenuIds) ? 'checked' : '' ?>>
                                    <?php echo $menu['name'] ?>
                                </label>
                                <br>
                            <?php endforeach ?>
